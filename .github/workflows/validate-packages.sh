...
<<<"$PACKAGES" tr ' ' '\n' | xargs -P10 -I{} ajv validate -d {} --spec=draft2020 -c ajv-formats -s official-mason-registry/schemas/package.schema.json -r 'official-mason-registry/schemas/{components,enums}/**/*.json'
